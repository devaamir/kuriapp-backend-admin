...
### **Nominate New Winner**
Current winner can nominate another member to receive the kuri for that month.

**Endpoint:** `POST /kuris/:id/nominate-winner`
...
```json
{
  ...
  "nomination": {
    "month": 2,
    "originalWinnerId": "u_105",
    "nominatedMemberId": "u_106",
    "status": "pending",
    "nominatedAt": "2024-06-15T10:30:00Z"
  }
}
```

**Note:** Only the current winner for that specific month can nominate a replacement. The nominated member must be part of the kuri.

---

### **Approve/Reject Nomination**
Kuri admin approves or rejects a winner nomination.

**Endpoint:** `POST /kuris/:id/approve-nomination`
...
**Note:** Only the kuri admin can approve or reject nominations. If approved, the winner is automatically updated. Set `approve: false` to reject.
